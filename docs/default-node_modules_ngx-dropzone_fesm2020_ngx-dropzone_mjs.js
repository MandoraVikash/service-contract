"use strict";
(self["webpackChunkcuba"] = self["webpackChunkcuba"] || []).push([["default-node_modules_ngx-dropzone_fesm2020_ngx-dropzone_mjs"],{
...
class NgxDropzoneComponent {
  ...
  extractFilesFromDirectory(directory) {
    ...
    function _getFileFromFileEntry() {
      _getFileFromFileEntry = (0,_Users_murchcode_Development_projects_service_contract_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (fileEntry) {
        try {
    ...
    return new Promise((resolve, reject) => {
      ...
      const readEntries = () => {
        dirReader.readEntries( /*#__PURE__*/function () {
          var _ref = (0,_Users_murchcode_Development_projects_service_contract_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (dirItems) {
            if (!dirItems.length) {
              resolve(files);
            } else {
...
//# sourceMappingURL=default-node_modules_ngx-dropzone_fesm2020_ngx-dropzone_mjs.js.map