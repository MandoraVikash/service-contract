...
export const content: Routes = [
  ...
  {
    path: "general",
    loadChildren: () => import("../../components/master/general/general.module").then((m) => m.GeneralModule),
  },
  {
    path: "item-services",
    loadChildren: () => import("../../components/master/item-services/item-services.module").then((m) => m.ItemServicesModule),
  },
  {
    path: "accounts",
    loadChildren: () => import("../../components/master/accounts/accounts.module").then((m) => m.AccountsModule),
  },
  {
    path: "widgets",
